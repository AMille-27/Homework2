...
function_writing <- function (list) { #creating a function with an input and hopefully I can fill in bp_list later
  mean(list)
} 


#I needed to somehow make mean the default for when I typed in chunk my function name (function_writing) it would return the mean hopefully it was numeric. If not another error would pop up. I would also be able to call my function in the console and it would yield the mean. And if I wanted other summary statistics then it would I would have to specify var (function_writing) or something similar.
